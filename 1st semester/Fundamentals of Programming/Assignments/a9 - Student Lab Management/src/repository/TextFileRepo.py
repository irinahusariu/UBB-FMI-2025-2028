        ...
        try:
            with open(self.filename, "r") as f:
                ...
                for line in f:
                    ...
                    if not line:
                        continue
                    student_id, name, group = line.split(",")
    ...
    def save_to_file(self):
        ...
        with open(self.filename, "w") as f:
            for s in self.students.values():
                f.write(f"{s.student_id},{s.name},{s.group}\n")
        ...
        try:
            with open(self.filename, "r") as f:
                ...
                for line in f:
                    ...
                    if not line:
                        continue
                    assignment_id, description, deadline = line.split(",")
                    self.assignments[int(assignment_id)] = Assignment(int(assignment_id), description, deadline)
        except FileNotFoundError:
            self.assignments = {}
    ...
    def save_to_file(self):
        ...
        with open(self.filename, "w") as f:
            for a in self.assignments.values():
                f.write(f"{a.assignment_id},{a.description},{a.deadline}\n")
        ...
        try:
            with open(self.filename, "r") as f:
                ...
                for line in f:
                    ...
                    if not line:
                        continue
                    grade_value, student_id, assignment_id = line.split(",")
                    key = (int(student_id), int(assignment_id))
                    if grade_value == "None":
                        grade_value = None
                    else:
                        grade_value = float(grade_value)
                    self.grades[key] = Grade(grade_value,int(student_id), int(assignment_id))
        except FileNotFoundError:
            self.grades = {}
            with open(self.filename, "w") as f:
                pass
    ...
    def save_to_file(self):
        ...
        with open(self.filename, "w") as f:
            for g in self.grades.values():
                f.write(f"{g.grade_value},{g.student_id},{g.assignment_id}\n")
