...
"""
from src.command_design_pattern.grade_commands import GradeStudentCommand
...
class GradeService:
    def __init__(self, grade_repo, student_repo, assignment_repo, undo_manager):
    ...
    def grade_student(self, student_id, assignment_id, grade_value):
        ...
        cmd = GradeStudentCommand(self.grade_repo, student_id, assignment_id, grade_value)
