...
from src.command_design_pattern.undo_redo_manager import UndoManager
...
def main():
    ...
    # Initialize services
    student_service = StudentService(student_repo, grade_repo, undo_manager)
    assignment_service = AssignmentService(assignment_repo, grade_repo, student_repo, undo_manager)
    grade_service = GradeService(grade_repo, student_repo, assignment_repo, undo_manager)

    populate_defaults(student_service, assignment_service, grade_service)
    ui = Console(student_service, assignment_service, grade_service, undo_manager)
    ui.start()
